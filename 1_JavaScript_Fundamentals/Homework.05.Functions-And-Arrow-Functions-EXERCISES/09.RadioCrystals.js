function radioCrystals(input) {
    ...
    let cut = function(x) {return x/4; };
    let lap = function(x) {return x - x * 0.2; };
    let grind = function(x) {return x - 20; };
    let etch = function(x) {return x - 2; };
    let xray = function(x)  {return x + 1; };
    let wash = function(x) {return parseInt(x);};
